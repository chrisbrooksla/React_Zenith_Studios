...
import { Card, CardImg, CardText, CardBody, CardTitle,CardHeader,CardImgOverlay, CardSubtitle, Button } from 'reactstrap';
      ...
      return(
            <React.Fragment>
                  ...
                  <CardHeader tag="h1">{this.props.studio.name}</CardHeader>
                        ...
                        <CardImg className="cardImg" height="300" src={this.props.studio.image} />
